/* קליטת חשבוניות -> n8n -> LlamaParse
   ...
   התהליך בנוי משלוש קריאות שונות, ובכוונה:
   ...
   3. אישור   קריאה אחת מרוכזת בסוף, אחרי שאיריס אישרה או תיקנה.
...
(function () {
  ...
  /* ========================= הגדרות =========================
     שלושת הוובהוקים של הוורקפלואו "Lehem veshemesh - Invoices".
  ...
  /* צילום מהטלפון יוצא 4 עד 12 מגה, וזה הרבה על הוויפיי של המטבח.
     הקטנה ל-2000 פיקסל בצלע הארוכה מורידה לכ-400 קילובייט בלי לפגוע
     בקריאות הספרות. PDF נשלח כמו שהוא. */
